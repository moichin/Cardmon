    ...
    return(
        <>
          <div className="snap-center size-full text-white flex flex-col text-xl shadow-lg shrink-0">
            ...
            <h2 className="flex w-full h-20 text-center items-center justify-center text-[64px] font-offbit font-bold leading-none tracking-wider mt-10">{stepsAnimation}</h2>
            <h3 className="flex w-full h-auto text-center items-center justify-center text-2xl font-offbit font-bold leading-none tracking-wider mt-4">STEPS</h3>
