...
export default function ExitMenu(){
    return (
        <>
        <Link className="absolute left-1/2 -translate-x-1/2 bottom-16 bg-black border-4 border-cardmon-orage size-16 rounded-full z-100 flex justify-center items-center" to='/'>
